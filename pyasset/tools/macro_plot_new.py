...
def cal_rolling_sharpe(ret: pd.Series, rf: Union[pd.Series, None], window: int, min_periods: int) -> pd.Series:
    """
    计算rolling sharpe
    ...
    rolling_sharpe = (ex_mean / std).dropna()
